...
//q:翻译一下HYSTERESIS
//a:温度的震荡范围，也就是说，如果温度在这个范围内，就不会触发保护
//q:翻译一下THERMAL_PROTECTION_PERIOD
//a:温度保护的周期，也就是说，如果温度在这个周期（时间）内，就不会触发保护
 ...
 */
//Q:TRANSLATE CONSECUTIVE TO CHINAESE
//A:连续
...
#define BABYSTEPPING
  ...
  //#define BABYSTEP_ZPROBE_OFFSET          // Combine M851 Z and Babystepping
    ...
    //q:翻译一下Enable graphical overlay on Z-offset editor
    //a:启用Z偏移编辑器上的图形叠加
  #endif
#endif
