...
#define CUSTOM_MACHINE_NAME "MKS GEN L"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  29.24
    #define DEFAULT_Ki   2.77
    #define DEFAULT_Kd 77.25
  #endif
#endif
 ...
 */
//q:翻译一下normally-closed switches to GND and D32
//a:通常关闭的开关到GND和D32
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -34, -3, -2.08 }
